...
public class Camera2 {
    ...
    public static final LinkedList<Camera2> cameras = new LinkedList<Camera2>();
    ...
    public Camera2(String name, double xOffset, double yOffset, double yawOffset, double pitchOffset, double rollOffset) {
    ...
    public static void setThresholds(double distanceThreshold, double ambiguityThreshold) {
        ...
        Camera2.ambiguityThreshold = ambiguityThreshold;
    }
    ...
    public static void updateAll() {
        for (final Camera2 camera : cameras) {
            camera.update();
        }
    }
