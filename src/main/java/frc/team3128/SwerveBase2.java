...
public abstract class SwerveBase2 extends SubsystemBase {
    ...
    public SwerveBase2(SwerveDriveKinematics kinematics, Matrix<N3, N1> stateStdDevs, Matrix<N3, N1> visionMeasurementDevs, SwerveModuleConfig... configs) {
