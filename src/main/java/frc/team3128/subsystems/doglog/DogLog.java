...
package frc.team3128.subsystems.doglog;
...
public class DogLog {
  ...
  protected static DogLogOptions options = new DogLogOptions(true, true, true);
  protected static DogLogLogger logger = createLogger();
  protected static boolean enabled = true;

  public static void setOptions(DogLogOptions newOptions) {
    if (newOptions == null) {
      newOptions = new DogLogOptions(false, false, true);
    }
