...
public enum RobotStates {
    ...
    RPL1(ElevatorStates.LOW_L1, IntakeStates.NEUTRAL, ManipulatorStates.NEUTRAL, slow, LedStates.DEFAULT),
    RPL2(ElevatorStates.L2, IntakeStates.NEUTRAL, ManipulatorStates.NEUTRAL, slow, LedStates.DEFAULT),
    RPL3(ElevatorStates.L3, IntakeStates.NEUTRAL, ManipulatorStates.NEUTRAL, slow, LedStates.DEFAULT), 
    RPL4(ElevatorStates.L4, IntakeStates.NEUTRAL, ManipulatorStates.NEUTRAL, slow, LedStates.DEFAULT),
    
    RSL1(ElevatorStates.HIGH_L1, IntakeStates.NEUTRAL, ManipulatorStates.OUT_L1, slow, LedStates.SCORE),
    RSL2(ElevatorStates.L2, IntakeStates.NEUTRAL, ManipulatorStates.OUT, slow, LedStates.SCORE),
    RSL3(ElevatorStates.L3, IntakeStates.NEUTRAL, ManipulatorStates.OUT, slow, LedStates.SCORE),
    RSL4(ElevatorStates.L4, IntakeStates.NEUTRAL, ManipulatorStates.OUT, slow, LedStates.SCORE),

    AUTO_HOLD(ElevatorStates.AUTO_HOLD, IntakeStates.NEUTRAL, ManipulatorStates.NEUTRAL, LedStates.AUTO_HOLD),
    ...
    public static final List<RobotStates> neutralStates = List.of(FULL_NEUTRAL, NEUTRAL);
    ...
    private RobotStates(ElevatorStates elevator, IntakeStates intake, ManipulatorStates manipulator, ClimberStates climber, LedStates led) {
        this(elevator, intake, manipulator, climber, 1, led);
    }
    ...
    private RobotStates(ElevatorStates elevator, IntakeStates intake, ManipulatorStates manipulator, double throttle, LedStates led) {
        this(elevator, intake, manipulator, ClimberStates.UNDEFINED, throttle, led);
    }

    private RobotStates(ElevatorStates elevator, IntakeStates intake, ManipulatorStates manipulator, LedStates led) {
        this(elevator, intake, manipulator, ClimberStates.UNDEFINED, 1, led);
    }

    private RobotStates(ClimberStates climber, ElevatorStates elevator, double throttle, LedStates led) {
        this(elevator, IntakeStates.UNDEFINED, ManipulatorStates.UNDEFINED, climber, throttle, led);
    }

    private RobotStates(ClimberStates climber) {
        this(ElevatorStates.UNDEFINED, IntakeStates.UNDEFINED, ManipulatorStates.UNDEFINED, climber, 1, LedStates.UNDEFINED);
    }
